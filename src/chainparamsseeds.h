#ifndef ELLOCASH_CHAINPARAMSSEEDS_H
#define ELLOCASH_CHAINPARAMSSEEDS_H
/**
 * List of fixed seed nodes for the ellocash network
...
#endif // ELLOCASH_CHAINPARAMSSEEDS_H

...
#ifndef ELLOCASH_WALLET_WALLET_H
#define ELLOCASH_WALLET_WALLET_H
...
public:
     ...
     * on this ellocash node, and set to 0 for transactions that were created
...
#endif // ELLOCASH_WALLET_WALLET_H

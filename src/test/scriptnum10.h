...
#ifndef ELLOCASH_TEST_SCRIPTNUM10_H
#define ELLOCASH_TEST_SCRIPTNUM10_H
...
{
    /**
 * The ScriptNum implementation from Ellocash Core 0.10.0, for cross-comparison.
 */
public:

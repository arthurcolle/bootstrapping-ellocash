...
#ifndef ELLOCASH_CONSENSUS_CONSENSUS_H
#define ELLOCASH_CONSENSUS_CONSENSUS_H
...
// version. The former uses Ellocash parameters, but if this fork is a fork
...
#endif // ELLOCASH_CONSENSUS_CONSENSUS_H

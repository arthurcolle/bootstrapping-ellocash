...
#ifndef ELLOCASH_QT_ELLOCASHUNITS_H
#define ELLOCASH_QT_ELLOCASHUNITS_H
...
/** Ellocash unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class EllocashUnits : public QAbstractListModel
{
    Q_OBJECT

public:
    explicit EllocashUnits(QObject* parent);

    /** Ellocash units.
      @note Source: https://en.ellocash.it/wiki/Units . Please add only sensible ones
     */
    enum Unit {
        LOC,
        mLOC,
...
typedef EllocashUnits::Unit EllocashUnit;

#endif // ELLOCASH_QT_ELLOCASHUNITS_H

...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the EllocashTestFramework
    pass

class ExampleTest(EllocashTestFramework):
    # Each functional test is a subclass of the EllocashTestFramework class.
    ...
    def custom_method(self):
        ...
        EllocashTestFramework class so other tests can use it."""

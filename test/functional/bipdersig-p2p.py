...
class BIP66Test(EllocashTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # ellocashd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and ellocashd produces more specific reject
            # reasons.

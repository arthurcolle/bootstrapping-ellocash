...
# TestNode: A peer we use to send messages to ellocashd, and store responses.
...
class CompactBlocksTest(EllocashTestFramework):
    ...
    # This test actually causes ellocashd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that ellocashd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for ellocashd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # ellocashd will not send blocktxn responses for blocks whose height is

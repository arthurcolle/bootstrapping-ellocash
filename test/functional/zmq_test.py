...
from test_framework.test_framework import EllocashTestFramework, SkipTest
from test_framework.util import (assert_equal,
                                 bytes_to_hex_str,
                                 hash256,
                                )

class ZMQTest (EllocashTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that ellocash has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("ellocashd has not been built with zmq enabled.")

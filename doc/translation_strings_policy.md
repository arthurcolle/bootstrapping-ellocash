...
This document provides guidelines for internationalization of the Ellocash Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `ellocash_en.ts` remains unchanged.

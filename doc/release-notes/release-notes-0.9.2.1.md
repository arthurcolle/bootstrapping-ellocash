Ellocash Core version 0.9.2.1 is now available from:

  https://ellocash.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 LOC to 0.01 LOC
...
- Fix "Start ellocash on system login"

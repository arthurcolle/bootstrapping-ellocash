Ellocash version 0.5.4 is now available for download at:
http://sourceforge.net/projects/ellocash/files/Ellocash/ellocash-0.5.4/
...
http://gitorious.org/ellocash/ellocashd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Ellocash-Qt notifications under Growl 1.3.
Increase required age of Ellocash-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxEllocash properly when installing Ellocash-Qt over it. (Windows)

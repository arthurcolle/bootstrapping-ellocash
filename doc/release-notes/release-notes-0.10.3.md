Ellocash Core version 0.10.3 is now available from:

  <https://ellocash.org/bin/ellocash-core-0.10.3/>
...
(see https://github.com/ellocash/ellocash/pull/6793, as well as the 0.11.0

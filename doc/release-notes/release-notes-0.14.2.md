Ellocash Core version 0.14.2 is now available from:

  <https://ellocash.org/bin/ellocash-core-0.14.2/>
...
(in Ellocash Core 0.10.3) it has been disabled by default.
...
Since 0.14.0 the approximate transaction fee shown in Ellocash-Qt when using coin
...
- #10228 `ae479bc` Regenerate ellocash-config.h as necessary (theuni)

Ellocash Core version 0.13.2 is now available from:

  <https://ellocash.org/bin/ellocash-core-0.13.2/>
...
- #8908 `4a974b2` Update ellocash-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow ellocash-tx to create v2 transactions (btcdrak)

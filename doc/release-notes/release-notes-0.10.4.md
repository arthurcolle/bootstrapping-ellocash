Ellocash Core version 0.10.4 is now available from:

  <https://ellocash.org/bin/ellocash-core-0.10.4/>
...
- #6953 `43c2789` Split ellocash-tx into its own package
- #6953 `dfe0d4d` Include ellocash-tx binary on Debian/Ubuntu

Ellocash Core version 0.9.4 is now available from:

  https://ellocash.org/bin/0.9.4/
...
this update is incompatible with the Ellocash system and could lead to consensus
forks.

Ellocash Core released binaries from https://ellocash.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~ellocash/+archive/ubuntu/ellocash
- A third-party or self-compiled Ellocash Core

upgrade to Ellocash Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.

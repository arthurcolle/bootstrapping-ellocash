Ellocash-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/ellocash/files/Ellocash/ellocash-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Ellocash
...
New/changed settings (command-line or ellocash.conf file)
--------------------------------------------------------

Download URL: https://sourceforge.net/projects/ellocash/files/Ellocash/ellocash-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 LOC fee schedule (users still pay 0.01 LOC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #ellocash00 - #ellocash99

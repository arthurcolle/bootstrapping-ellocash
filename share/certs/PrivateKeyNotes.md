...
unlocked to sign the Ellocash-Qt.app bundle.
...
allowing somebody to distribute a Ellocash-Qt.app or ellocash-qt-setup.exe with a valid
...
that the ellocash-qt.exe file inside the installer had not been tampered with.
